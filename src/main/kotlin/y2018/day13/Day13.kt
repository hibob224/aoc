...
object Day13 {
    ...
    init {
        network.simulate()
        firstCrash = network.crashSites.first()
        lastCart = network.carts.first()
    }

    fun solvePartOne() = "${firstCrash.first},${firstCrash.second}"
    fun solvePartTwo() = "${lastCart.x},${lastCart.y}"
}
